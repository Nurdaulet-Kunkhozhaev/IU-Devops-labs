...
```
user@nurdaulet ansible % ansible-playbook -i inventory/inventory.yaml playbooks/main.yaml --diff
...
TASK [geerlingguy.docker : include_tasks] **************************************
included: /Users/user/labs_devops/ansible/roles/geerlingguy.docker/tasks/setup-Debian.yml for vm
...
TASK [geerlingguy.docker : include_tasks] **************************************
included: /Users/user/labs_devops/ansible/roles/geerlingguy.docker/tasks/docker-compose.yml for vm
...
TASK [docker : include_tasks] **************************************************
included: /Users/user/labs_devops/ansible/roles/docker/tasks/setup-Debian.yml for vm
...
TASK [docker : include_tasks] **************************************************
included: /Users/user/labs_devops/ansible/roles/docker/tasks/docker-compose.yml for vm
...
```
user@nurdaulet ansible % ansible-inventory -i inventory/inventory.yaml --list
{
"_meta": {
"hostvars": {
"local": {
